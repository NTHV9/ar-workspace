-- Preserve invoice counts when the verified, same-publication child context proves an absent zero parent.
-- Positive, missing, stale, or conflicting absent-parent evidence remains unavailable.
