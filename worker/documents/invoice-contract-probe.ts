...
export async function readInvoiceFolioContract(reader:Pick<OperaReader,'reservationFolios'|'financialTransactionDetail'> & Partial<Pick<OperaReader,'invoicePostings'|'reservationInvoiceFolios'>>,invoice:DocumentInvoice){
 ...
 let postings:unknown,fullHistory:unknown;
