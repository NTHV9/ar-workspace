...
| C8 | Global budget, retention and storage UI: operations, additive schema, upload/read integration | Atomic concurrent reservations; unknown usage blocks new costly work; exact eligible-file inventory; one-month policy tested; unrelated/pending/reopened/shared files protected | Budget integrated/deployed/enabled321e96e; real221092byte read charged and rendered. Retention integrated/applied/deployed but cleanup awaits scoped provider tests before enabling |
| C9 | Recovery: migration filename alignment, included backup inventory, isolated restore and recovery write hold | No production restore; verify DB/object/provider boundaries; safe replay and post-backup Gmail reconciliation runbook; spend cap checked | 50-migration/14fixture actual synthetic pg_dump/pg_restore passed. Write hold and post-backup SENT audit implemented; deployment/live metadata audit pending |
