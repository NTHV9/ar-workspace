...
const base:AgingInvoice={id:'a',hotel:'KAT',accountId:'A',invoiceNo:'10',folioNo:'100',guest:'Zulu',date:'2026-09-02',age:null,open:100,role:'standalone',verified:true,parentId:null};
const rows=[base,{...base,id:'b',hotel:'TSK',invoiceNo:'2',folioNo:'20',guest:'Anna',date:'2026-09-01',age:3,open:-20}];
