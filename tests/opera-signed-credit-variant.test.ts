...
it.each([
 ...
 {name:'Aging totalOutstanding omits explicit currency',change:(raw:ReturnType<typeof fixture>)=>{Object.assign(raw.accountDetails.agingInfo.totalOutstanding.credit,{currencyCode:undefined});}},
