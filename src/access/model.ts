...
export interface UserAccess {email:string|null;displayName?:string|null;username?:string|null;memberId?:string;accountKind?:'email'|'username';administrator:boolean;regions:RegionId[];revision:number}
