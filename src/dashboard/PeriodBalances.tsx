 ...
 <section className="dashboard-period-details" aria-label="Closing-date billing and follow-up details">
  ...
  <div className="dashboard-insights">
   <section className="dashboard-surface dashboard-billing-insight" aria-label="Closing-date billing status"><header><div><h3>Billing progress</h3><p>Billing-required invoices at period end</p></div><CheckCircle2 size={20}/></header>
    ...
    {overview&&<div className="billing-hotel-comparison">{[['billed','Billed'],['unbilled','Not billed']].map(([key,label])=><div key={key}><h4>{label}</h4><HotelSplit rows={hotelMeasures(key)} id={'billing-'+key} label={label}/></div>)}</div>}
