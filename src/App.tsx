...
const UsersAccess=lazy(()=>import('./access/UsersAccess'));
...
export function App() {
  ...
  const accessKey=workspaceAccess?workspaceAccess.email+':'+workspaceAccess.revision+':'+workspaceAccess.regions.join(','):'';
