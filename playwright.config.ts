...
export default defineConfig({
  ...
  projects:[
    {name:'cloudflare',testIgnore:['**/pdf-editor.spec.ts','**/rich-message.spec.ts'],use:{baseURL:process.env.AR_TEST_URL||'https://ar-workspace.ar-c82.workers.dev'}},
    {name:'editor-harness',testMatch:['**/pdf-editor.spec.ts','**/rich-message.spec.ts'],use:{baseURL:'http://127.0.0.1:5191'}},
  ],
  reporter: 'list',
});
