...
- Statement ใช้ตัวสร้างของระบบเราเท่านั้นตามคำยืนยัน 10 กันยายน 2026; Invoice/Folio ใช้ OPERA API ตามเดิม คง Aging Summary ทั้งบัญชีและไม่เพิ่มป้ายสร้างโดยระบบ AR ลง PDF
